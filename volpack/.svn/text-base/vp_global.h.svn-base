...
struct _vp_context {			/* vpContext */
    ...
    int (*write_func) ANSI_ARGS((FILE  *, void *, unsigned)); /* write to file */
    int (*read_func) ANSI_ARGS((FILE  *, void *, unsigned));  /* read from file */ /*changed for windows*/
    

	
	void *(*mmap_func) ANSI_ARGS((FILE  *, unsigned, void *));/* memory map file */
...
/* vp_context.c */
extern double rint ANSI_ARGS((double x));
